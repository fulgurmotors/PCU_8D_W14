...
CRGB rev_lights_color[NUM_LEDS] = {
    red_rev_light,   red_rev_light,   red_rev_light,   red_rev_light,
    red_rev_light,   green_rev_light, green_rev_light, green_rev_light,
    green_rev_light, green_rev_light, blue_rev_light,  blue_rev_light,
...
int rev_lights_rpm(CRGB *leds, int gear, int rpm) {
  static const std::array<int, 2> rev_lights_rpm[8] = {
      {0, 12000}, {0, 12000}, {0, 12000}, {0, 12000},
      {0, 12000}, {0, 12000}, {0, 12000}, {0, 12000}};
